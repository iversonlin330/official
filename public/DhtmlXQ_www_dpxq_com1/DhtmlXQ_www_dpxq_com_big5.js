...
var tQZ='\u8ECA\u99AC\u76F8\u4ED5\u5E25\u4ED5\u76F8\u99AC\u8ECA\u70AE\u70AE\u5175\u5175\u5175\u5175\u5175\u8ECA\u99AC\u8C61\u58EB\u5C07\u58EB\u8C61\u99AC\u8ECA\u70AE\u70AE\u5352\u5352\u5352\u5352\u5352';
var iQZ='r1r2r3r4r5r4r3r2r1r6r6r7r7r7r7r7b1b2b3b4b5b4b3b2b1b6b6b7b7b7b7b7';
if (!DhtmlXQimgpath) var DhtmlXQimgpath='';if (!ads_dpxq) var ads_dpxq='';if (!isMXQ) var isMXQ=false;if (!ads_board) var ads_board='\u695A\u3000\u3000\u3000\u6CB3\u3000\u3000\u3000\u6F22\u3000\u3000\u3000\u754C';
...
S+=('</style>');
document.write(S+'<div id="message" style="position:absolute;left:'+(wm/10)+'px;top:'+hm+'px;width:'+(wm*0.8)+'px;border:2px solid #0f0;background-color:#f4fcf3;"><div style="margin:2px;color:#00f;text-align:center;height:'+(hm-lh-lh)+'px;width:'+(wm*0.8-4)+'px;overflow:hidden;" id="messdiv">DongPing DhtmlXQ ChessBoard Loading ......<br>Powered By dpxq.com Program Version '+PVer+'</div><div style="margin-bottom:'+(fz/2)+'px;text-align:center;width:100%;"><button style="width:'+(fz*5)+'px;margin-right:20%;" onclick="clickYES()">\u78BA \u5B9A</button><button style="width:'+(fz*5)+'px;" onclick="clickNO()">\u53D6 \u6D88</button></div></div><div id="divs" style="overflow:hidden;"></div><div id="divsave" style="display:none;overflow:auto;"></div>');
function $(o) {return document.getElementById(o);}
function $P(o){return parent.document.getElementById(o);}
function getInfo()
{
	var i,s='\u6642\u9593:'+(TT[1]-TT[0])+'ms '+(TT[3]-TT[2])+'ms '+(TT[5]-TT[4])+'ms\n';
	var FDBS=(''+(fdbs-0+0.001)).substr(0,4);
	s+='\u7248\u672C:'+PVer+'\n';
	s+='\u986F\u793A:'+(VIMG?'\u5716\u5F62':'\u6587\u672C')+'\n';
	s+='\u500D\u6578:'+FDBS+' '+(wTitle==350?'\u7121\u6CE8\u89E3\u8B8A\u8457':(wTitle==240?'\u53EA\u57FA\u672C\u68CB\u76E4':''))+'\n';
	...
	s+='\u6587\u5B57:'+fz+'px\n';
	s+='\u68CB\u683C:'+qgdx+'px\n';
	s+='\u68CB\u5B50:'+qzdx+'px '+(imgQiZi?(qznum+'\u5716\u5F62'):baseQiZi?'dataURL':UWD?'WebDings':'\u5B8B\u9AD4')+'\u68CB\u5B50\n';
	s+='\u7CFB\u7D71:'+(WIN.w95?'Win95':WIN.w9x?'Win9X':WIN.w2000?'Win2000':(WIN.wxp==1)?'WinXP':WIN.wxp?'WinXP+':WIN.mobile?'Mobile':'other')+'\n';
	s+='\u8A9E\u8A00:'+(ZHCN?'':'\u975E')+'\u7C21\u9AD4\u4E2D\u6587\n';
	s+='\u700F\u89BD:'+(NS.IE?('IE '+NS.IE):NS.Firefox?('Firefox '+NS.Firefox):NS.Chrome?('Chrome '+NS.Chrome):NS.Safari?('Safari '+NS.Safari):NS.Opera?('Opera '+NS.Opera):NS.WebKit?('WebKit '+NS.WebKit):NS.Gecko?('Gecko '+NS.Gecko):'other')+'\n';
	s+='\u6A21\u5F0F:'+(CSS1?'CSS1Compat':'BackCompat')+'\n';
	s+='\u4EE3\u78BC:'+(DhtmlXQimgpath==''?'\u540CHTML\u6587\u4EF6':DhtmlXQimgpath)+'\n';
	if (imgQiZi)
	{
		s+='\u5716\u7247:'+(IMGPATH==''?'\u540CHTML\u6587\u4EF6':IMGPATH)+'\n';
		s+='\u524D\u7DB4:'+CNTW+'\n';
		if (VIMG)
		{
			s+='\u80CC\u666F:'+BGIMG.split('(')[1].split(')')[0]+'\n';
			s+='\u6CE8\u89E3:'+CPIMG.split('(')[1].split(')')[0]+'\n';
			s+='\u68CB\u76E4:'+BDIMG.split('(')[1].split(')')[0]+'\n';
			if (qpbdxy) s+='\u504F\u79FB:'+qpbdxy.split(':')[1].split(';')[0]+'\n';
			s+='\u683C\u7DDA:'+LNIMG.split('(')[1].split(')')[0]+'\n';
			if (qplnxy) s+='\u504F\u79FB:'+qplnxy.split(':')[1].split(';')[0]+'\n';
			if (CLIMG) {s+='\u9EDE\u64CA:'+CLIMG.split('(')[1].split(')')[0]+'\n';
			if (qpclxy) s+='\u504F\u79FB:'+qpclxy.split(':')[1].split(';')[0]+'\n';}
		}
		if (qznum==7)
		{
			var t=[0,1,2,3,4,9,11];
			for(i=1;i<8;i++) s+='\u7D05'+tQZ.charAt(t[i-1])+':'+QZIMG[i]+'\n';
...
function getFont()
{
	var F=['\u5B8B\u9AD4,\u65B0\u5B8B\u9AD4,SimSun,NSimSun,\'MS Song\'','\u7D30\u660E\u9AD4,\u65B0\u7D30\u660E\u9AD4,MingLiU,PMingLiU'];
	if (isBIG5&&WIN.wxp==2)
	{
...
function showalert(sMag,sUrl,sLine,sFunc)
{
	...
	if (!!sUrl)
	{
		...
		if ((a>0&&a<15)||(b>0&&b<10)) sMag=('\u932F\u8AA4:'+sMag+' \u884C\u865F:'+sLine+'<br><nobr>\u7DB2\u5740:'+sUrl+'</nobr><br>\u8ACB\u6309Ctrl+F5\u5237\u65B0,\u5237\u65B0\u7121\u6548\u8ACB\u5831\u932F: <nobr><a target="_blank" href="tencent://message/?uin=88081492&Site=DhtmlXQ.'+location.hostname+'&Menu=yes"><img border="0" SRC="http://wpa.qq.com/pa?p=1:88081492:16" alt="\u9EDE\u64CA\u9019\u88CF\u767C\u6D88\u606F" /></a> <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&uid=hldcg&site=cntaobao&s=1&charset=utf-8" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=hldcg&site=cntaobao&s=1&charset=utf-8" alt="\u9EDE\u64CA\u9019\u88CF\u767C\u6D88\u606F" /></a></nobr>');
		else return false;
	}
...
function initboard()
{
	...
	s+=('<input type="button" style="'+bs+'left:0;" onclick="gotonum(\'First\')" value="\u958B\u5C40">');
	s+=('<input type="button" style="'+bs+'left:'+(bw+bsp)+'px;" onmouseup="gotonum(\'Prev\')" value="\u5F8C\u9000">');
	s+=('<input type="button" style="'+bs+'left:'+(2*bw+2*bsp)+'px;" onmouseup="gotonum(\'Next\')" value="\u524D\u9032">');
	s+=('<input type="button" style="'+bs+'left:'+(3*bw+3*bsp)+'px;" onclick="gotonum(\'Last\')" value="\u7D42\u5C40">');
	...
	s+=cDIV(6,1,w2-7,'',0,typ,'','\u68CB\u8B5C\u5E8F\u5217\u3000[<a href="javascript:HideMove();" id="hidemove">\u96B1\u85CF</a>]');
	...
	s+=('  <div id="move_0" onmouseup="gotonum(0)" style="background-color:'+bsColor+';color:#fff;">====\u68CB\u5C40\u958B\u59CB</div>');
	s+=('</div>');
	s+=('</div>');
	s+=('<input type="button" style="'+bs+'left:0;" value="\u65CB\u8F49" id="turn_Board" onclick="turnBoard()">');
	s+=('<input type="button" style="'+bs+'left:'+(bw+bsp)+'px;" value="\u5C0D\u7A31" id="mirror_Board" onclick="mirrorBoard()">');
	...
	s+=cDIV(6,1,w3-7,'',0,typ,'','\u6CE8\u89E3 <a href="javascript:TXTtoDhtmlXQ(cText)">\u6DFB\u52A0\u8457\u6CD5</a> <a href="javascript:EditComment(cText)" id="e_comm">\u4FEE\u6539\u6CE8\u89E3</a>');
	...
	s+=('</div>');
	s+=cDIV(6,thh+ch+((NS.IE&&NS.IE<9)?1:0),w3-7,'',0,typ,'','<span id="livevartxt">\u8B8A\u8457(\u55AE\u64CA\u9078\u64C7)</span>\u3000<a href="javascript:UpMove()" title="\u63D0\u5347\u7576\u524D\u8B8A\u8457">\u5347</a><a href="javascript:DownMove()" title="\u964D\u4F4E\u7576\u524D\u8B8A\u8457">\u964D</a><a href="javascript:DelMove()" title="\u522A\u9664\u672C\u6B65\u5F8C\u8457\u6CD5\u6216\u5B50\u8B8A\u8457\u6A39">\u522A</a>');
	...
	s+=('<input type="button" style="'+bs+'left:'+(bw+bsp)+'px;" value="\u5C0E\u51FA" id="showsource" onclick="ViewSource()">');
	s+=('<input type="button" style="'+bs+'left:'+(2*bw+2*bsp)+'px;width:'+(w3-bw*2-2*bsp)+'px;color:#f00;" value="\u68CB\u8B5C\u641C\u7D22" id="showsearch" onclick="ViewSearch()">');
	s+=('</div>');
	// source
	var w4=w2+w3+ps;
	...
	s+=cDIV(6,thh+ch+((NS.IE&&NS.IE<9)?1:0),w4-7,'',0,typ,'','<a href="javascript:void(0)" onclick="copycode(sText)" style="color:#f00">\u8907\u88FD\u4EE3\u78BC</a> <a href="javascript:setBinit(1)">\u5C07\u5DE6\u5074\u5C40\u9762\u8A2D\u7232\u958B\u59CB</a> <a href="javascript:setBinit(2)" style="color:#f00">\u6E05\u7A7A\u68CB\u76E4</a> <a href="javascript:setBinit(3)">\u65B0\u5C40</a>');
	...
	s+=('\u5C0E\u51FA\u4EE3\u78BC:<a href="javascript:getUBB()">UBB</a> <a href="javascript:getFLASH(0)" style="color:#f00">FLASH</a> <a href="javascript:getHTML()">HTM</a> <a href="javascript:getJAVA()">JAVA</a> <a href="javascript:getIFRAME()">FRAME</a> <a href="javascript:TreeSet(1)" style="color:#f00">\u6587\u672C</a>');
	s+=('<br>\u5C0E\u51FA\u4EE3\u78BC:<a href="javascript:getFLASH(4)"><span style="color:#F00">\u65B0\u6D6A</span>\u7DB2\u6613</a> <a href="javascript:getFLASH(1)">\u641C\u72D0</a> <a href="javascript:getFLASH(2)" style="color:#F00">QQ\u7A7A\u9593</a> <a href="javascript:getFLASH(3)">\u5E38\u898B\u8AD6\u58C7</a>');
	s+=('<br>\u5C0E\u51FA\u5C40\u9762:<a href="javascript:getIMGTEXT()">\u6F14\u64AD\u5BA4</a> <a href="javascript:getANIGIF()">GIF\u52D5\u756B</a> <a href="javascript:getFENTEXT()">\u68CB\u8EDFFEN\u4E32</a> <a href="javascript:getXQSJTEXT()">\u4E16\u5BB6</a>');
	s+=('<br>\u5C0E\u5165\u5C40\u9762:<a href="javascript:getBinit(\'xqstudio\')">\u6F14\u64AD\u5BA4\u68CB\u5716</a> <a href="javascript:getBinit(\'xqqb\')">\u8C61\u68CB\u8EDF\u4EF6FEN\u4E32</a> <a href="javascript:getBinit(\'xqsj\')">\u4E16\u5BB6</a>');
	s+=('<br>\u6DFB\u52A0\u68CB\u5B50:<span id="addred"><a href="javascript:addQizi(\'0_8\')">\u8ECA</a><a href="javascript:addQizi(\'1_7\')">\u99AC</a><a href="javascript:addQizi(\'9_10\')">\u70AE</a><a href="javascript:addQizi(\'11_12_13_14_15\')">\u5175</a><a href="javascript:addQizi(\'2_6\')">\u76F8</a><a href="javascript:addQizi(\'3_5\')">\u4ED5</a><a href="javascript:addQizi(\'4\')">\u5E25</a></span> <a href="javascript:addQizi(\'16_24\')">\u8ECA</a><a href="javascript:addQizi(\'17_23\')">\u99AC</a><a href="javascript:addQizi(\'25_26\')">\u70AE</a><a href="javascript:addQizi(\'27_28_29_30_31\')">\u5352</a><a href="javascript:addQizi(\'18_22\')">\u8C61</a><a href="javascript:addQizi(\'19_21\')">\u58EB</a><a href="javascript:addQizi(\'20\')">\u5C07</a>');
	s+=('<form id="treetxt" action="" name="treetxt" style="display:none;background-color:#fff;position:absolute;top:0;left:0;">');
	s+=('\u9EDE\u93C8\u63A5\u8A2D\u7F6E\u8B8A\u8457\u6587\u672C\u53C3\u6578--><a href="javascript:getTEXT(1)" style="color:#00f">\u78BA\u8A8D\u5C0E\u51FA</a> <a href="javascript:TreeSet(0)" style="color:#f00">\u8FD4\u56DE</a>');
	s+=('<br>\u5C0E\u51FA\u5167\u5BB9:<span id="nstart2"></span><a href="javascript:TreeSet(\'nstart\',0);" id="nstart0" style="color:#00f">\u25CE \u5168\u90E8</a> <a href="javascript:TreeSet(\'nstart\',1);" id="nstart1">\u25CE\u7576\u524D\u5C40\u9762</a> <a href="javascript:getTEXT(\'\');" id="nstart3">\u25CE\u7C21\u55AE\u6587\u672C</a>');
	s+=('<br>\u5C0E\u51FA\u683C\u5F0F:<span id="stype3"></span><a href="javascript:TreeSet(\'stype\',1);" id="stype1" style="color:#00f">\u25CE \u6A19\u51C6</a> <a href="javascript:TreeSet(\'stype\',0);" id="stype0">\u25CE\u5206\u96E2\u6A21\u5F0F</a> <a href="javascript:TreeSet(\'stype\',2);" id="stype2">\u25CE\u7DCA\u6E4A\u6A21\u5F0F</a>');
	s+=('<br>\u6BCF\u884C\u5217\u6578:<span id="col0"></span><a href="javascript:TreeSet(\'col\',1);" id="col1" style="color:#00f">\u25CE \u4E00\u5217</a> <a href="javascript:TreeSet(\'col\',2);" id="col2">\u25CE\u6BCF\u884C\u4E8C\u5217</a> <a href="javascript:TreeSet(\'col\',3);" id="col3">\u25CE\u6BCF\u884C\u4E09\u5217</a>');
	s+=('<br>\u9EDE\u64CA\u76F8\u61C9\u5C0E\u51FA\u683C\u5F0F\u93C8\u63A5\u7136\u5F8C\u9EDE\u78BA\u8A8D\u5C0E\u51FA\u5373\u53EF');
	s+=('<br>\u6CE8\u89E3\u884C\u9996<input type="text" name="zhustr" value="0"> \u8457\u6CD5\u884C\u9996<input type="text" name="lspace" value="4"> \u8457\u6CD5\u884C\u5C3E<input type="text" name="rspace" value="0">');
	s+=('<br>\u56DE\u5408\u5167\u5DE6<input type="text" name="lpad" value="1"> \u56DE\u5408\u5167\u53F3<input type="text" name="rpad" value="1"> \u56DE\u5408\u4E4B\u9593<input type="text" name="mspace" value="3">');
	s+=('<br>\u6CE8\u89E3\u6A19\u793A<input type="text" name="zhujie" value="*"> \u8B8A\u8457\u6A19\u793A<input type="text" name="bianzhao" value="B"> \u8B8A\u8457\u5C64\u6578<input type="text" name="maxdepth" value="999">');
	s+=('<br>\u6E05\u9664\u7A7A\u9805<input type="text" name="delempty" value="1"> \u8457\u6578\u8A18\u6578<input type="text" name="istwo" value="0"> \u6309\u5C64\u7DE8\u865F<input type="text" name="bianhao" value="1">');
...
function initdata()
{
	...
	if (PVer<getvar('pver')) xqtitle=('\u8ACB[<a href="http://www.dpxq.com/hldcg/dhtmlxq/" target="_black" style="color:#f00">\u9EDE\u6B64\u4E0B\u8F09</a>]\u6700\u65B0\u68CB\u76E4\u652F\u6301\u6587\u4EF6 <a href="javascript:void(0)" onclick="getInfo()">\u7248\u672C\u4FE1\u606F</a>');
	...
	MoveDIV.innerHTML='<div id="move_0" onmouseup="gotonum(0)" style="background-color:'+bsColor+';color:#fff;">====\u68CB\u5C40\u958B\u59CB'+havecomment(0,0)+'</div>';
	...
	if (getvar('class').search(/^[\u5C0D\u5C0D]\u5C40\u76F4\u64AD$/gi)==0) {div16.innerHTML=getvar('livetext');sText1.value='';LiveMain();}
	else {$('livevartxt').innerHTML='\u8B8A\u8457(\u55AE\u64CA\u9078\u64C7)';$('livetimediv').innerHTML='';div16.innerHTML=getrefer();if (aHeight>=w0||isSP||window==top) {getTEXT(getvar('txttype'));}}
...
function getMove(ev)
{
	...
	if (AllowAdd<32)
	{
		if (p.indexOf(ev)>=0) showalert('\u6B64\u8655\u6709\u68CB\u5B50');
	...
	if (move_ev!=''&&((LiveID<=0)||(LiveID>0&&(LiveAdmin||ev.length==4))))
	{
		...
		{
			VarAdd(PT,move_ev);
			if (LiveAdmin) showalert('<span><br>\u767C\u73FE\u8457\u6CD5\u8207\u539F\u8457\u6CD5\u4E0D\u540C<br>\u78BA\u5B9A\uFF1D\u6309\u7167\u65B0\u8457\u6CD5\u66F4\u65B0<br>\u53D6\u6D88\uFF1D\u7E7C\u7E8C\u63A8\u6F14\u4E0D\u66F4\u65B0</span>|getMove("'+PT+'")');
		}
	}
	if (!CSS)
	{
...
{
	var v=$('var_'+sMI[nnum]);
	var r='<div style="position:absolute;top:0;left:0;background-color:'+bsColor+';"><a href=javascript:getMove("'+m+'") style="margin-left:2px;line-height:'+(lh-1)+'px!important;line-height:'+(lh-2)+'px;color:#ff0;">\u9EDE\u6B64\u589E\u52A0\u8B8A\u8457'+cm+'</a></div>';
...
function HideMove()
{
	...
	$('hidemove').innerHTML=($('hidemove').innerHTML=='\u96B1\u85CF')?'\u986F\u793A':'\u96B1\u85CF';
}
function DP(p,z)
{
	if (z>=0&&z<=31)
...
function ViewSource()
{
	...
	$('showsource').value=($('showsource').value=='\u5C0E\u51FA'?'\u96B1\u85CF':'\u5C0E\u51FA');
	hideSearch();
}
function ViewSearch()
{
	$('searchText').style.display=($('searchText').style.display=='none'?'':'none');
	$('showsearch').value=($('showsearch').value=='\u68CB\u8B5C\u641C\u7D22'?'\u96B1\u85CF\u641C\u7D22':'\u68CB\u8B5C\u641C\u7D22');
	hideSource();
}
function hideSearch()
{
	$('searchText').style.display='none';
	$('showsearch').value='\u68CB\u8B5C\u641C\u7D22';
}
function hideSource()
{
...
{
	var m='\u8907\u88FD\u6210\u529F\uFF0C\u53EF\u7C98\u8CBC\u5C40\u9762\u5230\u8EDF\u4EF6\u4E2D\uFF0C\u6216\u767C\u8868\u68CB\u8B5C\u5230\u7DB2\u7AD9\u8AD6\u58C7\u4E2D<br>\u975EIE\u6838\u5FC3\u700F\u89BD\u5668\u5982\u679C\u6C92\u6709\u8907\u88FD\u6210\u529F\u8ACB\u81EA\u5DF1\u7528\u9F20\u6A19\u6216\u9375\u76E4\u8907\u88FD';
	...
	else
	{
		...
		if (!cc)
		{
			...
			else showalert('\u60A8\u7684\u700F\u89BD\u5668\u4E0D\u652F\u6301\u81EA\u52D5\u8907\u88FD\uFF0C\u8ACB\u6309Ctrl+C\u8907\u88FD');
			return;
		}
        }
	if (!t) showalert(m);
...
function checkDIY()
{
	...
	if (!d) {showalert('\u8ACB\u5237\u65B0[<a href="javascript:parent.show(3)" style="color:#f00;">\u9AD8\u7D1A\u641C\u7D22</a>]\u9801\u4FEE\u8907\u6B64\u554F\u984C');d=0;}
	return d;
}
...
function getSEARCH()
{
	...
	s+='<a href="javascript:SearchE()">\u641C\u7D22\u8207\u7576\u524D\u5B50\u529B\u76F8\u540C\u5C0D\u5C40</a>\u3000<a href="javascript:SearchE(2)">\u7D05\u52DD</a>\u3000<a href="javascript:SearchE(0)">\u9ED1\u52DD</a>\u3000<a href="javascript:SearchE(1)">\u548C\u68CB</a><br>';
	s+='<a href="javascript:SearchP(\'next\')">\u641C\u7D22\u8207\u7576\u524D\u5C40\u9762\u76F8\u540C\u5C0D\u5C40</a>\u3000<a href="javascript:SearchP(\'next\',2)">\u7D05\u52DD</a>\u3000<a href="javascript:SearchP(\'next\',0)">\u9ED1\u52DD</a>\u3000<a href="javascript:SearchP(\'next\',1)">\u548C\u68CB</a><br>';
	s+='<a href="javascript:SearchP(\'tnew\')">\u641C\u7D22\u7576\u524D\u5C40\u9762\u7684\u8B8A\u8457\u7D71\u8A08</a>\u3000<a href="javascript:SearchP(\'tnew\',2)">\u7D05\u52DD</a>\u3000<a href="javascript:SearchP(\'tnew\',0)">\u9ED1\u52DD</a>\u3000<a href="javascript:SearchP(\'tnew\',1)">\u548C\u68CB</a><br>';
	s+='<a href="javascript:SearchRB(\'red\')">\u641C\u7D22\u7D05\u65B9\u68CB\u624B\u7684\u6240\u6709\u5C0D\u5C40</a>\u3000<a href="javascript:SearchRB(\'red\',2)">\u52DD\u5C40</a>\u3000<a href="javascript:SearchRB(\'red\',0)">\u8CA0\u5C40</a>\u3000<a href="javascript:SearchRB(\'red\',1)">\u548C\u5C40</a><br>';
	s+='<a href="javascript:SearchRB(\'black\')">\u641C\u7D22\u9ED1\u65B9\u68CB\u624B\u7684\u6240\u6709\u5C0D\u5C40</a>\u3000<a href="javascript:SearchRB(\'black\',2)">\u52DD\u5C40</a>\u3000<a href="javascript:SearchRB(\'black\',0)">\u8CA0\u5C40</a>\u3000<a href="javascript:SearchRB(\'black\',1)">\u548C\u5C40</a><br>';
	s+='<a href="javascript:getFENTEXT(\'coffeecc\')">\u8207\u8EDF\u4EF6\u5C0D\u5F08</a>\u3000<a href="javascript:SearchEPOS(\'1009\')">\u67E5\u627E\u540C\u578B\u5C40</a>\u3000<a href="javascript:getFENTEXT(\'Paiendgame\')">\u641C\u7D22\u7576\u524D\u6B98\u5C40\u89E3\u6CD5</a><br>';
	s+='<div style="color:#00f;margin-bottom:12px;">\u4EE5\u4E0A\u93C8\u63A5\u5747\u53EF\u9EDE\u64CA\u641C\u7D22\uFF0C\u90E8\u5206\u529F\u80FD\u50C5\u6703\u54E1\u53EF\u7528</div>';
	s+='\u3000\u3000\u68CB\u8B5C\u5009\u5EAB\uFF0C\u767E\u842C\u68CB\u8B5C\uFF0C\u662F<span style="color:#f00;">\u6975\u5F37\u5927\u7684\u8C61\u68CB\u958B<br>\u5C40\u5EAB</span>\uFF0C\u53EF\u8F14\u52A9\u6162\u68CB\u958B\u5C40\uFF0C\u7814\u7A76\u68CB\u8B5C\u548C\u5C0D\u624B\u8CC7\u6599<br><a href="http://www.dpxq.com/hldcg/shop/vip.htm" target="_blank" style="color:#00f;">\u767E\u842C\u68CB\u8B5C\uFF0C\u63A2\u7D22\u4F48\u5C40\u6DF1\u5C64\u8B8A\u5316\uFF01\u6253\u8B5C\u8907\u76E4\uFF0C\u5206<br>\u6790\u81EA\u5DF1\u5C0D\u5C40\u5F97\u5931\uFF01\u8B8A\u8457\u7D71\u8A08\uFF0C\u5F08\u5929\u780D\u4EBA\u6700\u4F73\u5E6B<br>\u5147\uFF01VIP\u6703\u54E1\u6BCF\u5E74100\u5143\u62163000\u9EDE\uFF0C\u5F08\u5929\u6771\u90AA\u806F<br>\u7CFB<span style="color:#f00;">\u96FB\u8A7113898991761 QQ:88081492 \u65FA\u65FA:hldcg</span></a>';
	s+='<br>\u52D5\u614B\u68CB\u76E4\u751F\u6210\u9801\u9762 <a href="http://www.dpxq.com/hldcg/dhtmlxq/" target="_blank" style="color:#00f;">http://dhtmlxq.dpxq.com</a><br><a href="http://www.dpxq.com/" style="color:#00f;" target="_blank">\u4E2D\u570B\u8C61\u68CB\u68CB\u8B5C\u5009\u5EAB - \u6771\u840D\u8C61\u68CB\u7DB2</a> <a href="http://www.dpxq.com/hldcg/share/" style="color:#f00;" target="_blank">\u8C61\u68CB\u8B5C\u5927\u5168</a></div>';
...
function ViewMini(s)
{
	...
	if (s!=1) {showalert('\u78BA\u5BE6\u9700\u8981\u958B\u65B0\u7A97\u53E3\u7814\u7A76\u9EBC\uFF1F\u9EDE\u53D6\u6D88\u53EF\u76F4\u63A5\u5728\u68CB\u76E4\u4E0A\u8D70\u68CB|ViewMini(1)');return;}
...
function getFLASH(t)
{
	var s0='\u3000\u3000\u672C\u4EE3\u78BC\u53EF\u5728\u652F\u6301FLASH\u7684';
	var s2='\u4E0A\u767C\u4F48FLASH\u52D5\u614B\u68CB\u76E4';
	var s1='\r\n\u3000\u3000\u5E38\u898B\u8C61\u68CB\u7DB2\u7AD9\u90FD\u5DF2\u5B89\u88DDDhtmlXQ\u52D5\u614B\u68CB\u76E4\u986F\u793A\u652F\u6301\uFF0C\u8ACB\u60A8\u5C0E\u51FAUBB\u4EE3\u78BC\u767C\u8868\u68CB\u8B5C\r\n\r\n';
	var f1='http://'+(getvar('class').search(/^[\u5C0D\u5C0D]\u5C40\u76F4\u64AD$/gi)==0?'live':'www')+'.dpxq.com/DhtmlXQ_www_dpxq_com/DhtmlXQ.swf';
	if (t==2||t==4) {sText.value=s0+(t==2?'\u9A30\u8A0AQQ\u7A7A\u9593':'\u65B0\u6D6A\u535A\u5BA2\u6216\u7DB2\u6613\u535A\u5BA2')+s2+'\uFF0C\u8ACB\u4F7F\u7528\u6E90\u4EE3\u78BC\u65B9\u5F0F\u767C\u8868'+s1+'<embed src="'+f1+'" width="500" height="350" quality="high" wmode="transparent" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" FlashVars="DhtmlXQ='+get_arg().replace(/(\[\/?DhtmlXQ)\]/g,'$1FLASH]').replace(/[\r\n]/gi,'')+'" />';return;}
	var s=ViewUrl.match(/owner=[mnuw]\&id=[1-9](\d{1,8})?/gi);
	if (!s) {showalert("\u53EA\u6709\u6771\u840D\u68CB\u8B5C\u5009\u5EAB\u4E2D\u7684\u68CB\u8B5C\u624D\u53EF\u5C0E\u51FAFLASH\u4EE3\u78BC\uFF0C\u8ACB\u6CE8\u518A\u4E26\u767B\u9678\u68CB\u8B5C\u5009\u5EAB");return;}
	s=f1+'?DhtmlXQ='+s[0].substr(6).replace('&id=','')+'.swf';
	if (t==0) sText.value=s0+'\u4EFB\u610F\u7AD9\u9EDE\u4F7F\u7528\r\n\u65B0\u6D6A\u535A\u5BA2\uFF0C\u641C\u72D0\u8AD6\u58C7\uFF0CQQ\u7A7A\u9593\uFF0CDVBBS\u52D5\u7DB2\u3001PHPWind\u3001Discuz\u7B49\u5E38\u898B\u8AD6\u58C7\u53EF\u9EDE\u64CA\u76F8\u61C9\u93C8\u63A5\u76F4\u63A5\u5C0E\u51FA\u7B26\u5408\u8981\u6C42\u7684FLASH\u4EE3\u78BC'+s1+s;
	else if (t==1) sText.value=s0+'\u641C\u72D0\u8AD6\u58C7'+s2+'\uFF0C\u5982\u8981\u5728\u641C\u72D0\u535A\u5BA2\u767C\u8868\uFF0C\u8ACB\u63D0\u53D6FLASH\u5730\u5740\u7576\u4F5C\u8996\u983B\u4F86\u767C\u8868'+s1+'[media '+s+' width=500 height=350]';
	else if (t==3) sText.value=s0+'\u535A\u5BA2\u8AD6\u58C7'+s2+'\uFF0C\u5982\u8AD6\u58C7\u652F\u6301HTML\uFF0C\u4E5F\u53EF\u5C0E\u51FA[\u65B0\u6D6A]\u683C\u5F0F\u7684FLASH\u4EE3\u78BC\u4F86\u767C\u8868'+s1+'[flash=500,350]'+s+'[/flash]';
}
function getTEXT(v)
{
	var i,j;
	...
	var t='\u6A19\u984C: '+getvar('title')+'\r\n\u5206\u985E: '+getvar('class')+'\r\n\u8CFD\u4E8B: '+getvar('event')+'\r\n\u8F2A\u6B21: '+getvar('round')+'\r\n\u4F48\u5C40: '+getvar('open')+'\r\n\u7D05\u65B9: '+R_name+'\r\n\u9ED1\u65B9: '+B_name+'\r\n\u7D50\u679C: '+getvar('result').replace('\u7D05\u52DD','\u7D05\u65B9\u52DD').replace('\u9ED1\u52DD','\u9ED1\u65B9\u52DD')+'\r\n\u65E5\u671F: '+getvar('date').replace(/^(\d{2,4})\-(\d?\d)\-(\d?\d)$/gi,'$1\u5E74$2\u6708$3\u65E5')+'\r\n\u5730\u9EDE: '+getvar('place')+'\r\n\u7D44\u5225: '+getvar('group')+'\r\n\u53F0\u6B21: '+getvar('table')+'\r\n\u88C1\u5224: '+getvar('judge')+'\r\n\u8A18\u9304: '+getvar('record')+'\r\n\u8A55\u8AD6: '+getvar('remark')+'\r\n\u4F5C\u8005: '+getvar('author')+'\r\n\u5099\u6CE8: '+getvar('other')+'\r\n';
	t=(t+'\u7D50\u675F\u65B9\u5F0F: '+getvar('endtype')+'\r\n\u8A18\u6642\u898F\u5247: '+getvar('timerule')+'\r\n\u7D05\u65B9\u7528\u6642: '+getvar('redtime')+'\r\n\u9ED1\u65B9\u7528\u6642: '+getvar('blacktime')+'\r\n\u7D05\u7B49\u7D1A\u5206: '+r+'\r\n\u9ED1\u7B49\u7D1A\u5206: '+b+'\r\n\u68CB\u5C40\u985E\u578B: '+getvar('type')+'\r\n\u68CB\u5C40\u6027\u8CEA: '+getvar('gametype')+'\r\n\u7D05\u65B9\u5718\u9AD4: '+R_tnl[0]+'\r\n\u7D05\u65B9\u59D3\u540D: '+R_tnl[1]+'\r\n\u7D05\u65B9\u7B49\u7D1A: '+R_tnl[2]+'\r\n\u9ED1\u65B9\u5718\u9AD4: '+B_tnl[0]+'\r\n\u9ED1\u65B9\u59D3\u540D: '+B_tnl[1]+'\r\n\u9ED1\u65B9\u7B49\u7D1A: '+B_tnl[2]+'\r\n\u68CB\u8B5C\u4E3B\u4EBA: '+getvar('owner')+'\r\n\u68CB\u8B5C\u50F9\u503C: '+getvar('price')+'\r\n\u700F\u89BD\u6B21\u6578: '+getvar('hits')+'\r\n\u4F86\u6E90\u7DB2\u7AD9: '+unescape(getvar('refer')).split('\r')[0]).replace(/<[\x00-\xff][^>]*>/gi,'')+'\r\n \r\n';
	if (DelEmpty) t=t.replace(/[^\x00-\xff]{2,4}\: \r\n/gi,'');
	var s=' \r\n\u68CB\u8B5C\u7531 http://www.dpxq.com/ \u751F\u6210';
	...
	else
	{
		...
		tree=tree.join('');
		var temp=tree.match(/\u3010\u8B8A\{\$\d+\}\-\{\$\d+\}\-\d+\u3011/gi);
		if (temp!=null)
		{
			temp=temp.join('').replace(/\u3010\u8B8A\{\$(\d+)\}\-\{\$\d+\}\-\d+\u3011/gi,'|/\\\{\\\$ $1\\\}/gi').substr(1).replace(/ /gi,'').split('|');
			for (i=0;i<temp.length;i++) tree=tree.replace(eval(temp[i]),i);
			var result=getvar('result');
			if (nsMI=='0_1_0') tree=tree.replace('\u3010\u8B8A0-0-1\u3011','\u3010\u4E3B\u8B8A'+((result=='')?'':': ')+result+'\u3011');
			else tree=tree.replace(/\u3010\u8B8A0\-\{\$(\d+)\}\-\d+\u3011/i,'\u3010\u526F\u5716\u4E3B\u8B8A\u3011');
			tree=tree.replace(/.*\u7B2C [\d ]{3} (\u56DE\u5408[\u7D05\u9ED1]|\u8457)\: \u6709\[\u8B8A\{\$\d+\}\-\d+\-\d+.+\r\n/gi,'');
			if (stype!=0&&(i<=21||(i<=100&&v==2)))
			{
				...
				if (isTwo!='') tree=tree.replace(/\u3010\u8B8A(\d+)\-(\d+)\-(\d+)\u3011/gi,'\u8B8A{$1}\u63A5{$2}\u8B8A\u7B2C$3\u8457');
				else tree=tree.replace(/\u3010\u8B8A(\d+)\-(\d+)\-(\d+)\u3011/gi,'\u8B8A{$1}\u63A5\u8B8A{$2}\u7B2C$3\u56DE\u5408');
				tree=tree.replace(/.*\u7B2C [\d ]{3} (\u56DE\u5408[\u7D05\u9ED1]|\u8457)\: \u6709\[\u8B8A\d+\-\d+\-\d+.+\r\n/gi,'');
				for (j=0;j<i;j++) {tree=tree.replace(eval('/\\{'+j+'\\} ?/gi'),bz[j]);}
				tree=tree.replace(/\u63A5\u8B8A\u4E3B/gi,'\u63A5\u4E3B\u8B8A');
			}
			else tree=tree.replace(/\{\d+(\}\{\d+)*\}/gi,Bianzhao);
			tree=tree.replace(/\r\n(\s?\r\n)+/gi,'\r\n\r\n').replace(/\r\n\s?\r\n/gi,'\r\n \r\n');
			result=UBB.match(/\[(DhtmlXQ_move_\d+_\d+_\d+)\]\d+\[\/\1\]/gi);
			if (v==1) showalert('<div id="cNumDIV" style="text-align:center;">\u672C\u68CB\u8B5C['+getvar('title')+']\u5171\u542B'+result.length+'\u500B\u8B8A\u8457\uFF0C\u672C\u6B21\u5C0E\u51FA'+i+'\u500B['+tnum+'\u5C64]\u8B8A\u8457'+((result.length>i)?('\uFF0C\u9084\u6709'+(result.length-i)+'\u500B\u8B8A\u8457\u672A\u80FD\u5C0E\u51FA'):'')+'</div>'+(i>21?'<a href="javascript:void(0)" onclick="getTEXT(2)">\u9EDE\u6B64\u8907\u88FD\u53EF\u7C98\u8CBC\u5230word\u4E2D\u7684\u5E36\u5708\u6578\u5B57\u6587\u672C\uFF0C\u96FB\u8166\u89C0\u770B\u9700\u5B89\u88DDcNumber2\u5B57\u9AD4</a>':''));
		}
		else {tree='';i=100;}
		...
		if (v==2)
		{
			...
			$('cNumSPAN').innerHTML=(cc?'\u8907\u88FD\u6210\u529F\uFF0C\u8ACB\u7ACB\u5373\u7C98\u8CBC\u5230word\u4E2D\u4FDD\u5B58':'\u975EIE\u6838\u5FC3\u700F\u89BD\u5668\uFF0C\u8ACB\u6309Ctrl+C\u8907\u88FD');
		}
		if (isSP)
		{
...
function getTree(nsMI,depth,nNUM,nP,Maxdepth,stype,col,Lspace,Rspace,Mspace,Lpad,Rpad,Zhujie,Bianzhao,Zhustr,Maxpad,isTwo,Bianhao)
{
	...
	for (i=1;i<=l;i++)
	{
		...
		if (havevar(n[2],j)=='m')
		{
			...
			t=UBB.match(r);
			//m+=Bianzhao;
			c+=Lspace+'*\u7B2C '+('  '+((isTwo=='')?(j+j%2)/2:j)+'  ').match(/( \d |\d\d |\d\d\d)/gi)[0]+((isTwo=='')?(' \u56DE\u5408'+((j%2==0)?'\u9ED1':'\u7D05')):(' \u8457'))+': \u6709';
			for (k=0;k<t.length;k++)
			{
				t[k]=t[k].replace(r,'$2');
				m+='{{$'+t[k].split('_')[2]+'}}';
				c+=((k==0)?'':'\u3001')+'[\u8B8A{$'+t[k].split('_')[2]+'}-{$'+n[2]+'}-'+((isTwo=='')?(t[k].split('_')[1]-0+t[k].split('_')[1]%2)/2:t[k].split('_')[1])+']';
		...
		if (t!='')
		{
			...
			{
				m+=Zhujie;
				c+=Lspace+'*\u7B2C '+('  '+((isTwo=='')?(j+j%2)/2:j)+'  ').match(/( \d |\d\d |\d\d\d)/gi)[0]+((isTwo=='')?(' \u56DE\u5408'+((j%2==0)?'\u9ED1':'\u7D05')):(' \u8457'))+': '+t+'\r\n';
			}
		}
		else m+=' ';
	...
	t=(Bianhao==0)?0:depth;
	tree[t]+=' \r\n\u3010\u8B8A{$'+n[2]+'}-{$'+n[0]+'}-'+((isTwo=='')?(n[1]-0+n[1]%2)/2:n[1])+'\u3011'+m+((c=='')?'':'\r\n')+c;
...
function getFENTEXT(t)
{
	...
	if (t=='Paiendgame')
	{
		...
		if (f.replace(/[^rncp]/gi,'').length>12) showalert('<br>\u60A8\u61C9\u8A72\u5728\u96D9\u65B9\u653B\u5B50\u5C11\u4E8E4\u500B\u6642\u518D\u641C\u7D22');
...
{
	var p='',s,i;
	if (typeof(window.clipboardData)!='object') {showalert('\u60A8\u7684\u700F\u89BD\u5668\u4E0D\u652F\u6301\u5F9E\u526A\u8CBC\u677F\u4E2D\u7C98\u8CBC\u6578\u64DA\uFF0C\u56E0\u6B64\u7121\u6CD5\u4F7F\u7528\u672C\u529F\u80FD');return;}
	...
	else if (t=='xqstudio')
	{
		...
		{
			var tmpStr='';
			s=s.replace(/\xBA\xEC/gi,'\u7D05').replace(/\xBA\xDA/gi,'\u9ED1').replace(/\xB7\xBD/gi,'\u65B9').replace(/\xB3\xB5/gi,'\u8ECA').replace(/\xC2\xED/gi,'\u99AC').replace(/\xC5\xDA/gi,'\u70AE').replace(/\xCF\xE0/gi,'\u76F8').replace(/\xCF\xF3/gi,'\u8C61').replace(/\xCA\xBF/gi,'\u58EB').replace(/\xCB\xA7/gi,'\u5E25').replace(/\xBD\xAB/gi,'\u5C07').replace(/\xB1\xF8/gi,'\u5175').replace(/\xD7\xE4/gi,'\u5352').replace(/\xA1\xA1/gi,'\u3000').replace(/\xA9\xA6/gi,'\u2502').replace(/\xA9\xC0/gi,'\u251C').replace(/\xA9\xA4/gi,'\u2500').replace(/\xA9\xD8/gi,'\u2534').replace(/\xA3\xDC/gi,'\uFF3C').replace(/\xA3\xAF/gi,'\uFF0F').replace(/\xA9\xE0/gi,'\u253C').replace(/\xA1\xF9/gi,'\u203B').replace(/\xA9\xC8/gi,'\u2524').replace(/\xA9\xD0/gi,'\u252C').replace(/\xA9\xB4/gi,'\u2510').replace(/\xA9\xB0/gi,'\u250C').replace(/\xA9\xBC/gi,'\u2518').replace(/\xA9\xB8/gi,'\u2514');
			s=s.replace(/\r?\n|<br>/gi,'||').replace(/\u3000{19}\|\|/gi,'').replace(/(\-|&(nb|en)sp;|\u2002)/gi,' ').replace(/[\u3000\u2502\u251C\u2500\u2534\uFF3C\uFF0F\u253C\u203B\u2524\u252C\u2510\u250C\u2518\u2514]/gi,'  ');
			s=s.match(/( (\[[\u8ECA\u99AC\u8C61\u58EB\u5C07\u70AE\u5352]\]|\([\u5175\u70AE\u8ECA\u99AC\u76F8\u58EB\u5E25]\)|    ){9} \|\|){19}/gi);
			if (s==null) {showalert('\u4E0D\u662F\u8C61\u68CB\u6F14\u64AD\u5BA4\u6587\u672C\u68CB\u5716');return;}
			s=s[0].match(/ (\[[\u8ECA\u99AC\u8C61\u58EB\u5C07\u70AE\u5352]\]|\([\u5175\u70AE\u8ECA\u99AC\u76F8\u58EB\u5E25]\)|    ){9} \|\|/gi);
			for (i=0;i<s.length;i=i+2)
				tmpStr+=(s[i].substring(1,s[i].length-3).replace(/    /gi,' \u3000 ')+'|\u3000\n');
			p='(\u8ECA) (\u99AC) (\u76F8) (\u58EB) (\u5E25) (\u58EB) (\u76F8) (\u99AC) (\u8ECA) (\u70AE) (\u70AE) (\u5175) (\u5175) (\u5175) (\u5175) (\u5175) [\u8ECA] [\u99AC] [\u8C61] [\u58EB] [\u5C07] [\u58EB] [\u8C61] [\u99AC] [\u8ECA] [\u70AE] [\u70AE] [\u5352] [\u5352] [\u5352] [\u5352] [\u5352]'.split(' ');
			for (i=0;i<32;i++)
			{
...
function addQizi(z)
{
	...
	if (AllowAdd==32) showalert('\u68CB\u76E4\u4E0A\u4E0D\u7F3A\u5C11\u9019\u7A2E\u68CB\u5B50');
}
function EditComment(comm)
{
	if (isAddMove) {showalert('\u76EE\u524D\u5DF2\u9000\u51FA[\u589E\u52A0\u8457\u6CD5]\u72C0\u614B');$('e_comm').innerHTML='\u4FEE\u6539\u6CE8\u89E3';isAddMove=false;ShowCommentText();return;}
...
function getrefer()
{
	...
	var s='<div style="position:absolute;right:0;top:0;text-align:right;width:'+(fz*19+6)+'px;"><a href="javascript:void(0)" onclick="copysurl()">\u8907\u88FD\u7DB2\u5740</a>'+((isSP)?' <a href="javascript:digg(1)">\u597D\u8A55</a> <a href="javascript:digg(-1)">\u5DEE\u8A55</a> <a href="javascript:digg(0)">\u5831\u932F</a> <a href="javascript:gEvent()">\u8CFD\u4E8B</a> <a href="javascript:SearchP(\'tree\')">\u8B8A\u8457</a> <a href="javascript:SearchP(\'next\')">\u5C0D\u5C40</a>':'')+'</div>';
	return (s+'<div style="position:absolute;left:0;top:0;overflow:hidden;text-align:left;width:'+(fz*21)+'px;"><nobr><a href="javascript:void(0)" onclick="getInfo()">\u4F86\u6E90\u7DB2\u7AD9</a>\uFF1A<a href="'+SURL+'gourl.asp?site='+URLEscape(rer)+'&url='+URLEscape(rer)+'" style="color:#000;" target="_blank">'+rer+'</a></nobr></div><br><nobr>\u53C3\u8207\u8A0E\u8AD6\uFF1A<a href="'+SURL+'gourl.asp?site='+URLEscape(rer)+'&url='+URLEscape(rer_url)+'" style="color:#000;" target="_blank">'+rer_url+'</a></nobr>');
}
function gEvent() {}
function copysurl()
{
	...
	if (isSP)
	{
		...
		if (s==null) showalert('\u53EA\u6709\u6771\u840D\u68CB\u8B5C\u5009\u5EAB\u4E2D\u4FDD\u5B58\u7684\u68CB\u8B5C\u624D\u53EF\u8907\u88FD\u7DB2\u5740');
		else
		{
	...
	{
		var t='';
		if (getvar('title')!='') t+='\u6A19\u984C: '+getvar('title')+'\r\n';
		if (getvar('event')!='') t+='\u8CFD\u4E8B: '+getvar('event')+'\r\n';
		if (getvar('round')!='') t+='\u8F2A\u6B21: '+getvar('round')+'\r\n';
		if (getvar('open')!='')  t+='\u4F48\u5C40: '+getvar('open') +'\r\n';
		$('copytext').value=surl+'\r\n'+t;
		copycode($('copytext'),'\u5DF2\u6210\u529F\u8907\u88FD\u68CB\u8B5C\u7DB2\u5740\u5230\u526A\u8CBC\u677F\uFF0C\u53EF\u9EDE\u64CA\u4EE5\u4E0B\u7DB2\u5740\u67E5\u770B'+(wTitle==500?'\u6548\u679C':'')+(wTitle==240?'\uFF0C':'<br>\u975EIE\u6838\u5FC3\u700F\u89BD\u5668')+'\u5982\u6C92\u6709'+(wTitle==500?'\u8907\u88FD':'')+'\u6210\u529F\u8ACB\u81EA\u5DF1\u7528\u9F20\u6A19\u6216\u9375\u76E4\u8907\u88FD<br><a href="'+(murl?murl:surl)+'" target="_blank" style="color:#00f">'+(murl?murl:surl)+'</a>');
	}
}
function digg(price)
{
	showalert('\u53EA\u6709\u6771\u840D\u68CB\u8B5C\u5009\u5EAB\u4E2D\u4FDD\u5B58\u7684\u68CB\u8B5C\u624D\u53EF\u63A8\u85A6');
}
function getMovelistString(m0,p0)
{
	...
	for (i=0;i<ml;i++)
	{
		...
		if ((t>=0)&&(t<=15)) ms+=c_move(getMoveText(m[i],p,0));//0\u7D05
		else if ((t>=16)&&(t<=31)) ms+=c_move(getMoveText(m[i],p,1));//1\u9ED1
		else {ms+='\u8457\u6CD5\u932F\u8AA4';continue;}
...
function c_move(m)
{
	var b='\u8ECA\u99AC\u76F8\u8C61\u4ED5\u58EB\u5E25\u5C07\u70AE\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u5175\u5352\u4E00\uFF11\u4E8C\uFF12\u4E09\uFF13\u56DB\uFF14\u4E94\uFF15\u516D\uFF16\u4E03\uFF17\u516B\uFF18\u4E5D\uFF19\u524D\u4E2D\u5F8C\u9032\u9000\u5E73';
	var s='',n,x;
...
function LiveMain()
{
	...
	var s='\u5C0D\u4E0D\u8D77\uFF0C\u60A8\u7684\u700F\u89BD\u5668\u4E0D\u652F\u6301xmlhttp\u7D44\u4EF6\uFF0C\u8ACB\u4F7F\u7528\u65B0\u7248\u672C\u700F\u89BD\u5668';
...
function LiveShow()
{
	...
	showalert('\u76F4\u64AD\u7BA1\u7406\u54E1\uFF1A'+getvar('owner')+'<br><button onclick="clickYES()" style="margin-top:'+((hm-lh*3-fzt*2-fz)/2)+'px;font-size:'+(fzt+fz)+'px;line-height:'+(fzt+fz*2)+'px;height:'+(fzt*2+fz)+'px;width:'+(tWidth*0.16+fz*12)+'px;border-width:2px;">\u9032\u5165\u76F4\u64AD\u5BA4</button>|'+u);
}
function LiveSpeed()
{
...
function LiveMoveGet()
{
	...
	if (livef5!=null)
	{
		...
		if (ltitle>LiveF5Title) {LiveF5Title=ltitle;$('div1').innerHTML='<a href="javascript:LiveShow()">\u6A19\u984C\u6216\u7D50\u679C\u6709\u66F4\u65B0\uFF0C\u8ACB\u9EDE\u6B64\u91CD\u9032\u76F4\u64AD\u5BA4</a>';}
	}
...
function DownMove()
{
	...
	if (i==-l) ;
	else if (i==l-1) showalert('\u6700\u5F8C\u4E00\u500B\u8B8A\u8457\u4E0D\u80FD\u964D\u4F4E');
	else if (i==0)
	{
		m[1]=s[1].replace(r,'$1');
...
function DelMove(num)
{
	if (isNaN(num))
	{
		...
		else {showalert('\u771F\u7684\u8981\u522A\u9664'+((sMI[nnum]==pMI[nnum])?'\u5230\u6B64\u5C40\u9762':'\u6B64\u8B8A\u8457\u5206\u652F')+'\u9EBC|DelMove('+nnum+')');return;}
	}
...
function del0()
{
	showalert('\u6B64\u8B8A\u662F\u4E3B\u8457\u6CD5\uFF0C\u8ACB\u5148\u522A\u9664\u672C\u6B65\u4E4B\u5F8C\u7684\u9644\u5C6C\u8B8A\u8457');
}
...
function TXTtoDhtmlXQ(obj)
{
	...
	var s2='\u5F9E\u6CE8\u89E3\u4E2D\u63D0\u53D6\u7684\u8457\u6CD5\u5982\u4E0B\uFF0C\u6B64\u6642\u53EF\u4EE5\u6839\u64DA\u9700\u8981\u4FEE\u6539\u8457\u6CD5\uFF0C\u7136\u5F8C\u518D\u6B21\u9EDE\u64CA[\u6DFB\u52A0\u8457\u6CD5]\u93C8\u63A5\uFF0C\u5C07\u81EA\u52D5\u6DFB\u52A0\u7BAD\u982D\u4E4B\u5F8C\u7684\u4E2D\u6587\u8457\u6CD5\u5230\u68CB\u8B5C\u4E2D';
	if (isAddMove) {s0=str.split(s1);s2=s0[0];if (s0.length>1) str=s0[1];}
	else $('e_comm').innerHTML='\u8FD4\u56DE\u5E38\u614B';
	str=str.replace(/[\u8F66\u4F21\u7817\u4FE5\u7868]/gi,'\u8ECA').replace(/[\u9A6C\u508C]/gi,'\u99AC').replace(/\u5E05/gi,'\u5E25').replace(/\u5C06/gi,'\u5C07').replace(/\u540E/gi,'\u5F8C').replace(/\u8FDB/gi,'\u9032').replace(/[\u5305\u7832]/gi,'\u70AE');
	...
	var z='\u4E00\uFF11\u4E8C\uFF12\u4E09\uFF13\u56DB\uFF14\u4E94\uFF15\u516D\uFF16\u4E03\uFF17\u516B\uFF18\u4E5D\uFF19 \u8ECA\u99AC\u70AE\u76F8\u8C61\u4ED5\u58EB \u5E25\u5C07 \u5175\u5352 \u524D\u5F8C \u4E2D\u4E00\u4E8C\u4E09\u56DB\u4E94 \u9032\u9000\u5E73'.split(' ');
	var r=new RegExp('(['+z[1]+z[2]+z[3]+']['+z[0]+']|['+z[4]+']['+z[1]+']|['+z[4]+z[5]+']['+z[3]+z[0]+'])['+z[6]+']['+z[0]+']','ig');
	var m=str.match(r);
	if (m==null)
	{
		showalert('\u7BAD\u982D[<--]\u4E4B\u5F8C\u7121\u6709\u6548\u4E2D\u6587\u8457\u6CD5\uFF0C\u60A8\u53EF\u4EE5\u7C98\u8CBC\u65B0\u4E2D\u6587\u8457\u6CD5\u5F8C\u518D\u9EDE\u64CA[\u6DFB\u52A0\u8457\u6CD5]\u93C8\u63A5\u6216\u9EDE\u64CA[\u8FD4\u56DE\u5E38\u614B]\u93C8\u63A5\u8FD4\u56DE\u6B63\u5E38\u72C0\u614B');
		obj.value=s2+s1+'\r\n';isAddMove=true;
	}
	else
	{
		...
		for(i=0,j=0;i<m.length;i++)
		{
			...
			else {showalert(((msg==0)?('\u6B64\u6B65\u68CB['+m[i]+']\u4E0D\u7B26\u5408\u884C\u68CB\u898F\u5247'):msg)+'<br>\u6B64\u6642\u60A8\u4E5F\u53EF\u4EE5\u624B\u52D5\u8D70\u68CB\uFF0C\u522A\u6389\u932F\u8AA4\u8457\u6CD5\u518D\u7E7C\u7E8C');break;}
		}
		if (i>0) obj.value=s2+'\r\n'+m.slice(0,i).join('\r\n')+s1+'\r\n'+m.slice(i).join('\r\n');
		if (ms=='') return;
		var nsMI=sMI[nnum];
...
function get_MS(str,rb){
	...
	if('\u524D\u4E2D\u5F8C\u4E00\u4E8C\u4E09\u56DB\u4E94'.indexOf(str.charAt(0))>-1&&'\u5175\u5352'.indexOf(str.charAt(1))>-1)
	{
		man=(rb==1)?'p':'P';
		for (i=0;i<9;i++) {if (BPos[i].join('').search(eval('/.*'+man+'.*'+man+'.*/g'))!=-1) j+=i;}
		if (j.length>=2) return ('\u542B\u6709'+((rb==1)?'\u9ED1\u5352':'\u7D05\u5175')+'\u9054\u52302\u500B\u7684\u7E31\u5217\u5DF2\u8D85\u904E1\u5217');
		if (j.length==0) return ('\u6C92\u6709\u4EFB\u4F55\u5217'+((rb==1)?'\u9ED1\u5352':'\u7D05\u5175')+'\u9054\u52302\u500B');
		col=j;
		j=BPos[col].join('').split(man);
		if (j.length<=4)
		{
			if ((str.charAt(0)=='\u524D'&&rb==-1)||(str.charAt(0)=='\u5F8C'&&rb==1)) row=j[0].length;
			else if ((str.charAt(0)=='\u524D'&&rb==1)||(str.charAt(0)=='\u5F8C'&&rb==-1)) row=9-j[j.length-1].length;
		...
		else if (j.length==5)
		{
			...
			str=str.replace('\u524D','\u4E00').replace('\u5F8C','\u56DB');
		...
		{
			str=str.replace('\u524D','\u4E00').replace('\u4E2D','\u4E09').replace('\u5F8C','\u4E94');
			k=change_cols(str.charAt(0));
			if (rb==-1) row=j.slice(0,k).join(' ').length;
			else if (rb==1) row=j.slice(0,6-k).join(' ').length;
		}
	}
	else if('\u524D\u4E2D\u5F8C'.indexOf(str.charAt(0))>-1&&'\u4E00\uFF11\u4E8C\uFF12\u4E09\uFF13\u56DB\uFF14\u4E94\uFF15\u516D\uFF16\u4E03\uFF17\u516B\uFF18\u4E5D\uFF19'.indexOf(str.charAt(1))>-1)
	{
		man=(rb==1)?'p':'P';
		...
		if (j.length==2&&j.indexOf(col)>=0)
		{
			...
			else return ('\u7B2C'+str.charAt(1)+'\u5217'+((rb==1)?'\u9ED1\u5352':'\u7D05\u5175')+'\u6C92\u6709\u9054\u52303\u500B');
		}
		else return ('\u6C92\u6709\u96D9\u5217'+((rb==1)?'\u9ED1\u5352':'\u7D05\u5175')+'\u9054\u52302\u500B');
	}
	else if('\u524D\u5F8C'.indexOf(str.charAt(0))>-1&&'\u8ECA\u99AC\u70AE\u76F8\u8C61\u4ED5\u58EB'.indexOf(str.charAt(1))>-1)
	{
		man=change_name(str.charAt(1));
		if (rb==1) man=man.toLowerCase();
		for (i=0;i<9;i++) {if (BPos[i].join('').search(eval('/.*'+man+'.*'+man+'.*/g'))!=-1) break;}
		if (i==9) return ('\u672A\u767C\u73FE\u4EFB\u4F55\u5217\u6709\u5169\u500B'+((rb==1)?'\u9ED1':'\u7D05')+str.charAt(1));
		col=i;
		if ((str.charAt(0)=='\u524D'&&rb==-1)||(str.charAt(0)=='\u5F8C'&&rb==1)) row=BPos[col].join('').indexOf(man);
		else row=BPos[col].join('').lastIndexOf(man);
	}
	else if('\u8ECA\u99AC\u70AE\u5175\u5352\u76F8\u8C61\u4ED5\u58EB\u5E25\u5C07'.indexOf(str.charAt(0))>-1&&'\u4E00\uFF11\u4E8C\uFF12\u4E09\uFF13\u56DB\uFF14\u4E94\uFF15\u516D\uFF16\u4E03\uFF17\u516B\uFF18\u4E5D\uFF19'.indexOf(str.charAt(1))>-1)
	{
		...
		{
			if((str.charAt(2)=="\u9032"&&rb==-1)||(str.charAt(2)=="\u9000"&&rb==1)) row=9-j[2].length;
			else row=j[0].length;
		}
		else return ('\u68CB\u76E4\u7B2C['+str.charAt(1)+']\u5217\u6709['+(j.length-1)+']\u500B'+((rb==1)?'\u9ED1':'\u7D05')+'['+str.charAt(0)+']');
	}
	else return 0;
	...
	if(i>5)
	{
		...
		else {tcol=col;trow=row+((str.charAt(2)=="\u9032")?1:-1)*rb*change_cols(str.charAt(3));}
	}
...
{
	return 'RNCBBAAKKPP'.charAt('\u8ECA\u99AC\u70AE\u76F8\u8C61\u4ED5\u58EB\u5E25\u5C07\u5175\u5352'.indexOf(s));
}
